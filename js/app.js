...
class Sprite extends DisplayObject {
	constructor(name, texture, frames, width, height, x, y) {
...
class Fill extends DisplayObject {
	constructor(name, fill, width, height, x, y) {
...
class Pipes {
	...
	getRandom() {
		...
		return ROCK.MATH.random(this.MIN_Y, this.MAX_Y);
...
width = (!isTouch&&width>maxWidth?maxWidth:width),
scale = getScale(),
